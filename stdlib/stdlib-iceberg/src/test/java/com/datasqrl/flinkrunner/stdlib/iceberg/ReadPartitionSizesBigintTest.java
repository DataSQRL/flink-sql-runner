...
class ReadPartitionSizesBigintTest {

  @Test
  void testGetUnpartitionedIdReturnsMinus1() {
    var function = new read_partition_sizes_bigint();

    Long result = function.getUnpartitionedId();
